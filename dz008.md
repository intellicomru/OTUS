...
Threads fairness:
 ...
 Снова новый, тот же что и pgbench , рестартанул постгрю   
...
поставлю еще опыты на 100 гигов. Если что то интересное будет т.е. сильно отличаться - в слаке напишу. 

Вот еще один сохранившийся пример конфига (  [postgresql.conf ](postgresql.conf_08_1 ).  )   
но там прирост лишь чуть выше. Видимо на столь ограниченном железе сложно добиться хороших цифр. Т.к. например взятые конфиги с просторов интернета которые на их железе показывали выше цифры - у меня показывали примерно такие же. 
