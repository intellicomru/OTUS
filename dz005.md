...
Синхронная запись увеличивает время отклика команда COMMIT не возвращает управление до окончания синхронизации. 
